package com.example.filedemo.excelutils;
...
public class ExcelUtils {
     ...
     * @param colName
     */
    public static void initExcel(String fileName, String[] colName, String title) {
        format();
    ...
    public static <T> void writeObjListToExcel(List<T> objList, String fileName, Context c) {
        if (objList != null && objList.size() > 0) {
            WritableWorkbook westbrook = null;
            InputStream in = null;
            try {
                ...
                westbrook = Workbook.createWorkbook(new File(fileName), workbook);
                WritableSheet sheet = westbrook.getSheet(0);
                ...
                westbrook.write();
                Toast.makeText(c, "已保存到SD卡的根目录", Toast.LENGTH_SHORT).show();
            } catch (Exception e) {
                e.printStackTrace();
            } finally {
                if (westbrook != null) {
